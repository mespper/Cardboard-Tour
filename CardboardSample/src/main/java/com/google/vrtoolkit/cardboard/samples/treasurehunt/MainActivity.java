...
public class MainActivity extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    private FloatBuffer screenColors;
    ...
    private boolean viewMenu = true;
    private boolean viewTour = false;
    ...
    public void onSurfaceCreated(EGLConfig config) {
        ...
        ByteBuffer bbScreenVertices = ByteBuffer.allocateDirect(WorldLayoutData.SCREEN_COORDS.length * 4);
        bbScreenVertices.order(ByteOrder.nativeOrder());
        screenVertices = bbScreenVertices.asFloatBuffer();
        screenVertices.put(WorldLayoutData.SCREEN_COORDS);
        screenVertices.position(0);

        ByteBuffer bbScreenColors = ByteBuffer.allocateDirect(WorldLayoutData.SCREEN_COLORS.length * 4);
        bbScreenColors.order(ByteOrder.nativeOrder());
        screenColors = bbScreenColors.asFloatBuffer();
        screenColors.put(WorldLayoutData.SCREEN_COLORS);
        screenColors.position(0);
        ...
        GLES20.glAttachShader(screenProgram, gridShader);
        ...
        screenLightPosParam = GLES20.glGetUniformLocation(screenProgram, "u_LightPos");
        ...
        screenColorParam = GLES20.glGetAttribLocation(screenProgram, "a_Color");

        GLES20.glEnableVertexAttribArray(screenPositionParam);
        GLES20.glEnableVertexAttribArray(screenNormalParam);
        GLES20.glEnableVertexAttribArray(screenColorParam);
        ...
        Matrix.translateM(modelCube, 0, 0, 0, 0);
    ...
    public void drawScreen() {
        ...
        // Set ModelView, MVP, position, normals, and color.
        GLES20.glUniform3fv(screenLightPosParam, 1, lightPosInEyeSpace, 0);
        GLES20.glUniformMatrix4fv(screenModelParam, 1, false, modelFloor, 0);
        ...
        GLES20.glVertexAttribPointer(screenNormalParam, 3, GLES20.GL_FLOAT, false, 0,
                screenNormals);
        GLES20.glVertexAttribPointer(screenColorParam, 4, GLES20.GL_FLOAT, false, 0, screenColors);
